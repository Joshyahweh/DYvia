    ...
    <div className='w-full my-32'>
        <main className='max-w-[1240px] mx-auto'>
            <span className='text-center'>
                ...
                <p className='text-2xl py-6 text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum dolorum exercitationem odit. Iste soluta eum itaque dicta vel officiis mollitia.</p>
            </span>
